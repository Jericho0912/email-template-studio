...
Decisions 17 onwards (Cloudflare Access, D1, Rate Limiting binding, JSON Schema props contract, Worker Loaders) are proposed in `docs/PLAN.md` section 1 and get a numbered record here when the phase that uses them lands.
